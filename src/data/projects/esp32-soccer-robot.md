...
- Genuine multi-touch support, so forward+left or backward+right register as one diagonal move instead of two conflicting button presses — important for the fast direction changes a match demands
